...
const accordionItems = [
    {
        ...
        content: (
            <>
                <p>
                    Estamos aquí para asegurar que su estancia en <span translate="no"> "Las Brisas de Cix" </span> sea lo más agradable posible. Si necesita asistencia o tiene alguna pregunta, no dude en contactarnos a través de los siguientes medios:
                </p>
                <ul>
